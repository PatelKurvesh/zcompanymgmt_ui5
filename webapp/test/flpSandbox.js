		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zcompanymgmt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcompanymgmt-display": {
								"semanticObject": "zcompanymgmt",
								"action": "display",
								"description": "SAP Fiori Application For Company Management",
								"title": "Company Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcompanymgmt",
									"url": sap.ui.require.toUrl("zcompanymgmt")
								}
							}
						}
					}
